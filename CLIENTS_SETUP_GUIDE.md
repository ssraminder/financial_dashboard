...
- ✅ Manual client creation and editing
...
3. Choose import options:
   - ☑ **Update existing clients** - Updates clients that match by XTRF ID
   - ☑ **Add new clients** - Imports clients not in your database
   - ☐ **Mark missing as inactive** - Sets clients not in CSV as inactive
...
1. Click the ⋮ menu on a client row
2. Select **"Delete"**
...
1. ✅ Import your XTRF client database
2. ✅ Review and update client financial settings
...
**🎉 You're all set! Navigate to `/clients` to start managing your client database.**
